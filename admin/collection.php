...
if(isset($_POST['sub']))
{
    ...
    mysqli_query($conn,"INSERT INTO collection_tb(materials_collected,quantity) VALUES ('$rqr','$quant')");
                                            ...
                                            <div class="col-lg-7" id="frm" align="center">
                                                <div class="card">
                                                    <div class="card-header" align="center">
                                                        <strong>MATERIALS</strong>collected
                                                    </div>
                                                    <div class="card-body card-block">
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                              ...
                                                              <div class="row form-group">
                                                                <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Materials</label></div>
