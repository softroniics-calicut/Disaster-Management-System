...
$edd=mysqli_query($conn,"SELECT * FROM guest_tb WHERE guest_id='$details'");
...
$query=mysqli_query($conn,"SELECT *FROM area_tb");
 ...
 mysqli_query($conn,"UPDATE guest_tb SET name='$nm',mobile_no='$ph',email_id='$mail' WHERE guest_id='$details'");
                                                        ...
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                           ...
                                                           <!--  <div class="row form-group">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input onclick="clearerror('smob')" type="text" id="num" name="fon" class="form-control" value="<?php echo $result['mobile_no'];?>"><span id="smob" style="color: red"></span></div>
                                                            </div>
                                                              <div class="row form-group">
